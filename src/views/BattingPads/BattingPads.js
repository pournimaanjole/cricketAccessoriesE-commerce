...
import battingpdas from './../CricketAccessories/BattingPads.json'
const BattingPads = () => {
    const [battingpads ,setbattingpads] = useState(battingpdas)
  return (
    <div>
     <Navbar1/>
     <Navbar/>
