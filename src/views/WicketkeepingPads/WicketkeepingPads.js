...
import wicketkeepinggloves from './../CricketAccessories/WicketkeepingGloves.json'
const WicketkeepingPads = () => {
    const [wicketpdas,setwicketpads] = useState(wicketkeepinggloves)
  return (
    <div>
        <Navbar1/>
        <Navbar/>
...
export default WicketkeepingPads
