...
import './RubberSole.css'
import Navbar from '../../components/Navbar/Navbar'
import Navbar1 from '../../components/Navbar1/Navbar1'
import ProductCard from '../../components/ProductCard/ProductCard'
import rubbersole from './../CricketShoes/RubberSole.json'
const RubberSole = () => {
    const [rubberSole,setRubbersole] = useState(rubbersole)
  return (
    <div>
      <Navbar1/>
      <Navbar/>
