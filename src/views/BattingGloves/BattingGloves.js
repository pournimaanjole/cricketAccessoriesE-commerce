...
import battingGloves from './../CricketAccessories/BattingGoves.json'
const BattingGloves = () => {
    const [battinggloves,setbattinggloves] = useState(battingGloves)
  return (
    <div>
        <Navbar1/>
        <Navbar/>
